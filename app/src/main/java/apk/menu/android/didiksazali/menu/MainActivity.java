package apk.menu.android.didiksazali.menu;
...
public class MainActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Integer[] icons ={R.drawable.tv,R.drawable.smartphone,R.drawable.kulkas,R.drawable.meja};
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        try{
            ...
            if(str=="SMARTPHONE"){
                ...
                Intent intentSmartphone = new Intent(getApplicationContext(), SmartphoneActivity.class);
                startActivity(intentSmartphone);
            }
            if(str=="KULKAS"){
                Toast.makeText(getApplicationContext(), "Harga Kulkas", Toast.LENGTH_SHORT).show();
                Intent intentKulkas = new Intent(getApplicationContext(), KulkasActivity.class);
                startActivity(intentKulkas);
            }
            if(str=="MEJA"){
                Toast.makeText(getApplicationContext(), "Harga Meja", Toast.LENGTH_SHORT).show();
                Intent intentMeja = new Intent(getApplicationContext(), MejaActivity.class);
